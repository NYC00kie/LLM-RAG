...
prompt = PromptTemplate(
    ...
    Refrain from answering any questions that have no direct connection to moodle
...
# Example usage
question = "How would I go about writing a Plugin for Moodl, where I have an interactive Chat with someone else ?"
